...
#define SECRET_PASS "SJWBT-8FPA" // replace MyPassword with your WiFi password

#define SECRET_CH_ID 1603613      // replace 0000000 with your channel number
#define SECRET_WRITE_APIKEY "ILDK8QAMDCCEWS5X"   // replace XYZ with your channel write API Key
